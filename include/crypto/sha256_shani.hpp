...
inline uint8_t sha256_bip39_msg1_variable_shani(
    __m128i STATE0_r3, __m128i STATE1_r3,
    __m128i MSG0, __m128i MSG2, __m128i MSG3,
    __m128i ABEF_SAVE, __m128i CDGH_SAVE,
    const uint8_t* data16)
{
    ...
    _mm_storeu_si128((__m128i*)res, STATE0);
    return static_cast<uint8_t>(res[0] >> 24);
}

inline uint8_t sha256_bip39_first_byte_shani(const uint8_t block64[64]) {
    uint32_t state[8] = {
